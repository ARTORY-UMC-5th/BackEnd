...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:8080","http://localhost:3000","https://art-story.site","https://umc-artory.com", "https://artory-front-server.s3-website.ap-northeast-2.amazonaws.com")
