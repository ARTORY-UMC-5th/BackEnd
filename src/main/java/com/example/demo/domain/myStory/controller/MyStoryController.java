...
public class MyStoryController {
    ...
    @GetMapping("/info")
    public ResponseEntity<MyStoryResponseDto> getMemberInfo(@MemberInfo MemberInfoDto memberInfoDto) {
        MyStoryResponseDto myStoryResponseDto = myStoryService.getMemberInfo(memberInfoDto);
